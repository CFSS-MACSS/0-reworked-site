...
* **Final assignment**: an opportunity to bring all the skills together
...
* We will follow the on-your-machine setup
...
## Good code (hypothetical example)
...
ggplot(penguins, aes(x = body_mass_g, y = flipper_length_mm, col = species)) +
    geom_point() + 
    labs(title = "Relationship Between Flipper Size and Body Mass for 333 Palmer Penguins",
...
* Zoom images
* [CONFIGURE GIT](https://cfss-macss.netlify.app/setup/git/git-configure/) (must be done prior to class tomorrow!)
* Look over [Assignment 1](https://cfss-macss.netlify.app/assignments/1-edit-readme/)
