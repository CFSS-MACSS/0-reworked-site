...
For example, if you type `https://macss.uchicago.edu/current-student-resources` into your web browser and hit enter, these steps occur under the hood:
...
We will review the first two in class. Please, work through the other examples on your own.
...
* full data available for bulk download as CSV files from their website; but frequently you only need to obtain a handful of indicators or a subset of countries
...
**Looking for more examples?** See the A6 instructions for suggestions
...
1. However, this is insecure, especially if you plan to put your work on GitHub. We don't want to risk committing this line and pushing it to our public GitHub page. Instead, you should (please do so for your A6):
