...
- Assignment 1: due soon!
  ...
  - check general rubric and assignment-specific rubric on our website
  
  
- Yesterday: github, visualization and ggplot2
...
```{r out.width = "80%"}
include_graphics(path = "https://allisonhorst.github.io/palmerpenguins/reference/figures/lter_penguins.png")
```
...
* For more on `.` vs `.data`, [see this exchange on stack overflow](https://stackoverflow.com/questions/63399011/what-is-the-difference-between-and-data)
...
Think of the FLOW as moving through the PIPES (more on this later!)
...
Pipes simplify your code and make your operations more intuitive, BUT they are not the only way to write your R code... in fact for a long time they did not even exist in R! [See here to learn more](https://www.tidyverse.org/blog/2023/04/base-vs-magrittr-pipe/)

 > You will see them two ways (%>% and |>): both are correct. The book favors |> and I favor %>%
...
(group work)
* Accept assignment (individually): [https://classroom.github.com/a/oX3fYgiL](https://classroom.github.com/a/oX3fYgiL)
* Summarize penguins in interesting way
* Call `data()` in R
...
* Commit and push! (not graded -- for practice only!)
...
---
# NEW IMPROVED CLONING!

I have an additional (non-shell/terminal!) way to clone!

* Accept the assignment
* go to your new repo
* copy the link
* In RStudio: (top left) Go to File > New Project > Version Control > Git > (navigate to where you want, and add the relevant details -- folder name, git url!)
