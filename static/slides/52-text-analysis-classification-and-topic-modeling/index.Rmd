...
```{r fig.align = "center", echo = FALSE, out.width = "90%", dpi= 400}
...
```{r echo=FALSE, fig.cap="Wordcloud of most frequent tokens in Taylor Swift songs", out.width = '50%', dpi = 300}
...
--
```{r echo=FALSE, fig.cap="Word cloud of popular tokens", out.width = '60%', dpi = 300}
knitr::include_graphics(here("static", "img", "ts_wordcloud.png"))
...
The `syzuhet` package provides access to several sentiment/emotion lexicons:
...
**Another example (in today's class-materials)**: sentiment analysis of text from The Office
