...
`usethis::use_course("CFSS-MACSS/str-regex")`
  * by typing this into your CONSOLE (and answering R's version of 'yes' twice) and it will AUTOMATICALLY DOWNLOAD to your machine!
  * tutorial developed from Sabrina Nardin (thanks!)
...
* Homework assignment: finish [A3](assignments/3-dviz) and start [A5](assignments/5-debugging-rmarkdown/).
