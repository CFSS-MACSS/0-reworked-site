...
* Required: read [Ch 9](https://r4ds.hadley.nz/layers.html), [Ch 10](https://r4ds.hadley.nz/EDA.html)  
...
* Antony Unwin [Graphical Data Analysis with R](https://catalog.lib.uchicago.edu/vufind/Record/11609643#). It covers a range of graphical methods for data exploration and analysis; draws on packages beyond `ggplot2` for statistical graphics.Add commentMore actions
