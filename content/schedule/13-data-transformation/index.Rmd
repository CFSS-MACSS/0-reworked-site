...
* Required: read Chapter 3 "Data Transformation" and Chapter 18 "Pipes" from [R for Data Science](https://r4ds.hadley.nz/)
...
* Cheat sheet [Data Transformation with `dplyr`](https://nyu-cdsc.github.io/learningr/assets/data-transformation.pdf)
* Cheat sheet [Data Tidying with `tidyr`](https://github.com/rstudio/cheatsheets/blob/main/tidyr.pdf)
