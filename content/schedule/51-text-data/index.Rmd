...
For this and the following lecture we use the book [*Tidy Text Mining with R*](http://tidytextmining.com/). Start with Ch 1 and 2. 
...
[Tidytext mining](http://tidytextmining.com/) read Chapter 1, 3, and 4. Before next class: read chapters 2 and 6
