...
* Go [to this link](https://classroom.github.com/a/ZuGDMiSQ) to accept and create your private `FINAL` repository on GitHub. Once you do so, your repository will be built in a few seconds. It follows the naming convention `FINAL-<USERNAME>`  
...
After you have accessed the `FINAL` repository (see above), follow the [same steps you completed for `hw01`](/homework/edit-readme/) to clone the repository.
...
To submit the assignment, simply push to your repository the last version of your assignment before the deadline. Then copy your repository URL (e.g., `https://github.com/cfss-hmwks-s23/FINAL-jmclip`) and submit it to Canvas under FINAL before the deadline.
